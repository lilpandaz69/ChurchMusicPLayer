...
('اصليله', 'فريق قلب داود', 'اصليله تحير عقلي تدابيره.mp3', 'اصليله.jpg');
('استيقظي', 'تاسوني / ماري عزيز', 'استيقظي.mp3', 'download(3).jpg');
('البابا والحرامية', 'بولس ملاك', 'البابا والحراميه.mp3', 'download(4).jpg');
('الرب قريب لمن يدعوه', 'زياد شحاتة', 'الرب قريب لمن يدعوه.mp3', 'download(5).jpg');
('الكل يمضي ويزول', 'ابونا يوسف اسعد', 'الكل يمضى و يزول.MP3', 'download(6).jpg');